...
To grant a tester a promotional RevenueCat entitlement without charging them:

```bash
npm run tester:premium -- rider@example.com
npm run tester:premium -- rider@example.com 6
```
